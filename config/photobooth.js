...
function init() {
  ...
  function startWebcam() {
        ...
        .catch(function (e) {
          ...
          switch (e.name) {
            case "NotAllowedError":
              document.getElementById("savedImages").innerHTML =
                "<h3>You can't use this app because you denied camera access. Refresh the page and allow the camera to be used by this app.</h3>";
              break;
            case "NotReadableError":
              document.getElementById("savedImages").innerHTML =
                "<h3>Camera not available. Your camera may be used by another application.</h3>";
              break;
            case "NotFoundError":
              document.getElementById("savedImages").innerHTML =
                "<h3>Camera not available. Please connect a camera to your computer.</h3>";
              break;
          }
        });
    } else {
    ...
    document
      .getElementById("buttonCapture")
      .addEventListener("mousedown", handleButtonCaptureClick);
    ...
    //   .addEventListener("mousedown", handleButtonSaveClick);
